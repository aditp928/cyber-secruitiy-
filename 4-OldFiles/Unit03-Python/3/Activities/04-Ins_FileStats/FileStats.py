...
# If a potentially malicious file is uncovered, sometimes it is best to just remove it right off the bat
# This can be done using os.remove()
os.remove("Resources/BigOlWallpaper.jpg")

# The os.rmdir() function could also be used to remove entire folders but this is a bit more risky since it will delete all of the files within it as well
